    ...
    <>
      ...
      <AuthLayout>
        ...
        <section className="flex flex-col min-[350px]:flex-row gap-4">
          <Button className={`w-full text-[12px] bg-gray-800 text-white hover:bg-gray-900 ${loading && "opacity-50 pointer-events-none"}`} asChild>
            <Link href={"#"}>
          ...
          <Button className={`w-full text-[12px] bg-red-700 text-white hover:bg-red-900 ${loading && "opacity-50 pointer-events-none"}`} asChild>
            <Link href={"#"}>
