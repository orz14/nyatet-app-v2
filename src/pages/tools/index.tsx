...
function ToolsIndexPage({ authLoading }: any) {
  const title = "Tools";
  const breadcrumb = [
    {
      isLink: false,
      ...
      <Layout>
        <div className="space-y-4">
          ...
          {authLoading ? (
            ...
            <div className="w-full bg-gray-950 border border-gray-900 rounded-lg p-4 space-y-2">
...
export default AdminCheck(ToolsIndexPage);
